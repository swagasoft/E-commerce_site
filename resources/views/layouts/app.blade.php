...
<body>
    <div id="app">
        ...
        <main class="py-4">
            ...
            <div class="container">
                {{-- nav2 --}}
                <ul class="nav nav-tabs bg-dark " style="margin-top:auto">
                        <li class="nav-item">
                          <a class="nav-link text-white " href="#">Shoes</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link text-white" href="#">mobile phones</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link text-white" href="#">Foods</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link text-white" href="#">Travels</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link text-white" href="#">party</a>
                        </li>
                        <li class="nav-item">
